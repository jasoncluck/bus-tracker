...
describe StopsController do
  ...
  describe "GET new" do
    it "assigns a new stop as @stop" do
      ...
      assigns(:stop).should be_a_new(Stop)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created stop as @stop" do
        post :create, {:stop => valid_attributes}, valid_session
        assigns(:stop).should be_a(Stop)
        assigns(:stop).should be_persisted
      end

      it "redirects to the created stop" do
        post :create, {:stop => valid_attributes}, valid_session
        response.should redirect_to(Stop.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved stop as @stop" do
        ...
        Stop.any_instance.stub(:save).and_return(false)
        post :create, {:stop => {}}, valid_session
        assigns(:stop).should be_a_new(Stop)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested stop" do
        ...
        Stop.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, {:id => stop.to_param, :stop => {'these' => 'params'}}, valid_session
      end
      ...
      it "redirects to the stop" do
        stop = Stop.create! valid_attributes
        put :update, {:id => stop.to_param, :stop => valid_attributes}, valid_session
        response.should redirect_to(stop)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the stop as @stop" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Stop.any_instance.stub(:save).and_return(false)
        put :update, {:id => stop.to_param, :stop => {}}, valid_session
        assigns(:stop).should eq(stop)
      end
